...
<div class="row">
    ...
    <div class="col-lg-12 mb-4">
        ...
        <div class="card shadow mb-4">
            ...
            @endif
            <form action="{{ url('typemaquina') }}" method="POST" class="submit-prevent-form">
            {{csrf_field()}}
                <div clasd="form-group">
                <label for=""> Tipo de Máquina:</label>
                <input class="form-control" type="text"  name="namem" value="{{old('namem')}}" class="@error('namem') is-invalid @enderror">
                @error('namem')
